...
light ellipse (default) or dark ellipse.
"""
...
class DetectorApp:
    ...
    def build_controls(self):
        ...
        options.grid(row=5, column=0, columnspan=3, sticky="w", pady=(4, 3))
        tk.Checkbutton(
            options,
        ...
        center_frame.grid(row=6, column=0, columnspan=3, sticky="w", pady=(2, 5))
        ...
        self.palette_frame.grid(row=7, column=1, columnspan=2, sticky="w", pady=(0, 8))
        tk.Label(self.palette_frame, text="Not implemented yet", fg="#666666").grid(
            row=0, column=0, sticky="w"
        )
        button_frame = tk.Frame(frame)
        button_frame.grid(row=8, column=0, columnspan=3, sticky="w", pady=(2, 0))
        ...
        tk.Label(
            ...
            justify="left",
            wraplength=1150,
        ).grid(row=9, column=0, columnspan=3, sticky="ew", pady=(8, 0))
    ...
    def build_previews(self):
        ...
        tk.Label(frame, textvariable=self.center_preview_label).grid(
    ...
    def pending(self, *_args):
        self.status.set(
            "Settings changed. This milestone contains the GUI only; no detector recomputation is performed."
        )
