...
C=Path('/mnt/data/snippets/threshold_finder_candidate_v2.py');ROOT=Path('/mnt/data/corpus_compare');OUT=Path('/mnt/data/tests/histogram_full_stressset_part2.csv')
...
wanted_prefixes=['0162','0165','0173','0188','0200','0203']
